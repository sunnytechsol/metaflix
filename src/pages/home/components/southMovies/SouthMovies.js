...
export default class SouthMovies extends Component {
    render() {
        return (
            <div className='hindi-movies text-light my-5'>
                <div className="container-fluid px-5">
                    <div className="heading d-flex justify-content-between align-items-center">
                        <h4 className='text-uper'>South Indian Movies</h4>
                    ...
                    <div className="movies-list mt-4">
                        <div class="owl-carousel owl-theme owl-loaded owl-drag" id="south-movies">
